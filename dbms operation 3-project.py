...
db.execute('insert into school(i,j,k) values(?,?,?)',('2', 'nahid',  '5'))
db.execute('insert into school(i,j,k) values(?,?,?)',('3', 'Rasel',  '8'))
db.execute('insert into school(i,j,k) values(?,?,?)',('4', 'Pranto', '9'))
db.execute('insert into school(i,j,k) values(?,?,?)',('5', 'Raihan', '8'))
